...
public class DefaultColorizationTest {
    ...
    private DefaultColorization maven340;
    ...
    public void init() {
        ...
        maven340 = new DefaultColorization(new DefaultColorConfiguration(), newerVersion);
    }
    ...
    public void should_display_bold_plugin_execution_with_cyan_module_name() throws Exception {
        ...
        assertThat(maven340.colorize(message)).isEqualTo(
            ansi()
                .bold()
                .a("--- maven-surefire-plugin:2.19.1:test (default-test) @ ")
                .reset().toString()
    ...
    public void should_display_module_header_in_cyan(String message) throws Exception {
        ...
        assertThat(maven340.colorize(message))
            .isEqualTo(ansi().fgBright(CYAN).a(message).reset().toString());
    }
    ...
    public void should_not_colorize_message_containing_building_without_being_a_module_header() throws Exception {
        ...
        assertThat(maven340.colorize(message)).isEqualTo(message);
    }
    ...
    public void should_display_success_in_green(String message) {
        ...
        assertThat(maven340.colorize(message)).isEqualTo(ansi().fgBright(GREEN).bold().a(message).reset().toString());
    }
    ...
    public void should_display_failure_in_red(String message) {
        ...
        assertThat(maven340.colorize(message)).isEqualTo(ansi().fgBright(RED).bold().a(message).reset().toString());
    }
    ...
    public void should_display_skipped_in_yellow() {
        ...
        assertThat(maven340.colorize(message)).isEqualTo(ansi().fgBright(YELLOW).bold().a(message).reset().toString());
    }
